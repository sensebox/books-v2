...
<div class="container">
    <div class="row">
        <div class="col-md">
            <img src="../../pictures/blocks/display_initialise.png" alt="block" align="left">
        </div>
        <div class="col-md">
    ...
    <div class="row">
        <div class="col-md">
            <img src="../../pictures/blocks/display_show.png" alt="block" align="left">
        </div>
        <div class="col-md">
    ...
    <div class="row">
        <div class="col-md">
            <img src="../../pictures/blocks/display_clear.png" alt="block" align="left">
        </div>
        <div class="col-md">
    ...
    <div class="row">
        <div class="col-md">
            <img src="../../pictures/blocks/display_print.png" alt="block" align="left">
        </div>
        <div class="col-md">
            <h4>stationäre senseBox</h4>
            Verwende diesen Block, wenn du eine stationäre senseBox registriert hast. Für jeden Messwert benögtist du jeweils einen eigenen
    ...
    <div class="row">
        <div class="col-md">
            <img src="../../pictures/blocks/display_plot.png" alt="block" align="left">
        </div>
        <div class="col-md">
            <h4>mobile senseBox</h4>
            Verwende diesen Block, wenn du eine stationäre senseBox registriert hast. Für jeden Messwert benögtist du jeweils einen eigenen
